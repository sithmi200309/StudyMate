...
const loadTasks = async () => {
  const response = await fetch("https://studymate-production-f6e1.up.railway.app/tasks");
  tasks.value = await response.json();
};

const addTask = async () => {
  await fetch("https://studymate-production-f6e1.up.railway.app/tasks", {
    method: "POST",
    headers: {
...
const deleteTask = async (id) => {
  await fetch(`https://studymate-production-f6e1.up.railway.app/tasks/${id}`, {
    method: "DELETE"
  });
